                    ...
                    <div class="container footerWidget widget_area sidebarStyleDark">
                        <aside class="col-md-3 col-sm-6 widgetWrap widget widget_socials">
                            <div class="widget_inner">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="assets/page/multimedia/images/logo/46x60.png" alt="">
                                        <div class="logo_info">
                        ...
                        <aside class="col-md-3 col-sm-6 widgetWrap widget widget_recent_posts">
                            ...
                            <article class="post_item with_thumb first">
                                <div class="post_thumb">
                                    <img alt="New Post With Image" src="assets/page/multimedia/images/90x70.png">
                                </div>
                                <h5 class="post_title">
                                    <a href="#">New Post With Image</a>
                                </h5>
                            ...
                            <article class="post_item with_thumb">
                                <div class="post_thumb">
                                    <img alt="House Market Indicators" src="assets/page/multimedia/images/90x70.png">
                                </div>
                                <h5 class="post_title">
                                    <a href="#">House Market Indicators</a>
                                </h5>
                            ...
                            <article class="post_item with_thumb">
                                <div class="post_thumb">
                                    <img alt="Post With Image" src="assets/page/multimedia/images/90x70.png">
                                </div>
                                <h5 class="post_title">
